...
public class DataframeTest {
	...
	public void testCSVConstructor() throws Exception {
		...
		// Labels
		assertEquals("Ann̩e", (String) data.getLabel(0));
		assertEquals("Constructeur", (String) data.getLabel(1));
		assertEquals("Mod̬le", (String) data.getLabel(2));
	...
	public void testAccessByLabel() throws Exception {
		...
		assertEquals(1996, data.get(3, "Ann̩e"));
		
		assertEquals(Integer.class, data.getType("Ann̩e"));
		assertEquals(Double.class, data.getType("Prix"));
		assertEquals(String.class, data.getType("Mod̬le"));
	}
